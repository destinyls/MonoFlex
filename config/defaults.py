...
_C.DATASETS.USE_BORDER_CUT = True
_C.DATASETS.USE_COLOR_PADDING = True
_C.DATASETS.USE_MIXUP = True
_C.DATASETS.CONSIDER_OUTSIDE_OBJS = False
_C.DATASETS.USE_PROJ_2D_CLSES = [0, 1, 2]
_C.DATASETS.CLS_THRESHOLD = 0.70
_C.DATASETS.GEO_CONF_THRESHOLD = 0.85

_C.DATASETS.MAX_OBJECTS = 40
# _C.DATASETS.MIN_RADIUS = 1.5
# _C.DATASETS.MAX_RADIUS = 3.0
...
_C.MODEL.HEAD.GATE_HEAD = False
_C.MODEL.HEAD.GATE_NUM = 4
_C.MODEL.HEAD.GATE_CHANNEL = 48
_C.MODEL.HEAD.GATE_GROUP = False
_C.MODEL.HEAD.GATE_UNCERTAINTY = False
_C.MODEL.HEAD.GATE_RELU = True
_C.MODEL.HEAD.GATE_DEPTH_WEIGHT = 1.0
_C.MODEL.HEAD.GATE_KEYPOINT_WEIGHT = 1.0 

_C.MODEL.HEAD.BIAS_BEFORE_BN = True
_C.MODEL.HEAD.BN_MOMENTUM = 0.1

_C.MODEL.HEAD.BINARY_ASSIGN = False
# extra branch
_C.MODEL.HEAD.ASSIGN_EXTRA_BRANCH = False
# detach features from depth and keypoints
_C.MODEL.HEAD.BINARY_DETACH_FEATURE = True
# channel
_C.MODEL.HEAD.BINARY_CHANNEL = 48

_C.MODEL.HEAD.UNCERTAINTY_INIT = True

_C.MODEL.HEAD.UNCERTAINTY_BIAS = True
_C.MODEL.HEAD.UNCERTAINTY_RANGE = [-10, 10]
_C.MODEL.HEAD.UNCERTAINTY_WITH_UV = False
_C.MODEL.HEAD.UNCERTAINTY_WEIGHT = 1.0
_C.MODEL.HEAD.APPLY_UNCERTAINTY_CORNER_REG = False

# Reference depth
# Car 28742 28.01284 16.320597
# Cyclist 1627 24.664486 14.43946
# Pedestrian 4487 17.433151 11.120861
# all three classes 34856 26.494627 16.05988

_C.MODEL.HEAD.KEYPOINT_LOSS = 'L1'
_C.MODEL.HEAD.KEYPOINT_COMPACT = False
_C.MODEL.HEAD.KEYPOINT_NORM_FACTOR = 1.0

_C.MODEL.HEAD.CORNER_LOSS_DEPTH = 'direct'
_C.MODEL.HEAD.SMART_CORNER_LOSS = False
...
_C.MODEL.HEAD.REGRESSION_OFFSET_NORMAL = False
...
_C.MODEL.HEAD.USE_UNCERTAINTY = True
_C.MODEL.HEAD.UNCERTAINTY_WEIGHT_CLS = False
# _C.MODEL.HEAD.RESET_UNCERTAINTY = True
...
_C.MODEL.HEAD.INIT_LOSS_WEIGHT = [2, 2, 4, 1, 0.5, 1, 1, 1]
...
_C.MODEL.HEAD.EDGE_FUSION_BEFORE_HEAD = False
_C.MODEL.HEAD.EDGE_FUSION_BEFORE_RELU = False

_C.MODEL.HEAD.TRUNCATION_APPLY_HEADS = False

_C.MODEL.HEAD.TRUNCATION_OFFSET_LOSS = 'L1'
_C.MODEL.HEAD.TRUNCATION_CLS_RELU = False
_C.MODEL.HEAD.TRUNCATION_OFFSET_RELU = False
...
_C.MODEL.HEAD.ADAPTIVE_WEIGHTED_LOSS = False
...
# grad clip, not used
_C.SOLVER.GRAD_NORM_CLIP = 9999

# ReduceLROnPlateau
_C.SOLVER.PLATEAU_PARAMS = ['mode', 'factor', 'patience', 'threshold', 'threshold_mode']
_C.SOLVER.PLATEAU_PARAM_VALUES = ['max', 0.5, 4, 0.5, 'abs']

# ExponentialLR
_C.SOLVER.EXP_GAMMA = 0.9
...
_C.TEST.BOUNDARY_NMS = False
_C.TEST.BOUNDARY_NMS_KERNEL_SIZE = 5
